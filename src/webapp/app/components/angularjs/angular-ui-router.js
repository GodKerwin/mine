...
(function (window, angular, undefined) {
    ...
    /**
     * Finds the system ancestor path between two states.
     *
    ...
    /**
     * Merges a set of parameters with all parameters inherited between the system parents of the
        ...
        this.study = function (invocables) {
            ...
            return function (locals, parent, self) {
                ...
                function invoke(key, invocable, params) {
                    ...
                    // resolve; in that case study() will have made sure it's ordered before user in the plan).
...
// Register as a provider so it's available to other providers
   ...
   * });
     ...
     *
     * States often have things in system, and the primary way of factoring out these
   ...
   *     }
         ...
         *   but can provide inherited properties to its system children states.
   ...
   * } }
     ...
     * });
             ...
             * specified in a parent state. Parameter inheritance only works between system ancestor states, I.e.
